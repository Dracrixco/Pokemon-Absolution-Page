    ...
    <div className="mt-8 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div className="p-6">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl border-2 border-gray-200">
          ...
          <div
            className="relative mx-auto border-2 border-gray-300 rounded-lg overflow-hidden shadow-inner bg-white"
            style={{
              width: 16 * 16,
              height: 16 * 16,
            }}
          >
            {showMap && (
              <img
                ...
                alt="Map"
                className="absolute top-0 left-0 z-0 w-full h-full transition-opacity duration-300"
            ...
            {showTrainers && (
              <img
                ...
                alt="Trainers"
                className="absolute top-0 left-0 z-10 w-full h-full transition-opacity duration-300"
            ...
            {showObjects && (
              <img
                ...
                alt="Items"
                className="absolute top-0 left-0 z-20 w-full h-full transition-opacity duration-300"
            ...
            {!showMap && !showTrainers && !showObjects && !showPokemon && (
              <div className="absolute inset-0 flex items-center justify-center bg-gray-100">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm">Activa alguna capa</p>
                </div>
              </div>
            )}
          </div>
