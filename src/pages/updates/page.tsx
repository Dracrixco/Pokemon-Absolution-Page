...
export function UpdatesPage() {
  ...
  const copyUpdateToClipboard = (update: Update) => {
            ...
            {updates.map((update, index) => (
              ...
              >
                ...
                <div className="text-right mt-4">
                  <button
                    onClick={() => copyUpdateToClipboard(update)}
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        strokeWidth={2}
                        d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h6a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v6"
                      />
                    </svg>
                    Copy to Clipboard
                  </button>
