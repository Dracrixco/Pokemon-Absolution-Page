...
export const moves: Move[] = [
  ...
  },
  {
    ...
    suffix: "normal",
    passiveEffect:
      "If the Pokemon can't escape or switch, it generates a proto-shield each turn.",
  },
  {
    id: "WILDPUNCH",
    name: "Wild Punch",
  ...
  },
  {
    ...
    totalPP: 15,
    target: "NearOther",
    description: "Deals double damage to Dragon-type Pokemon.",
    suffix: "normal",
    passiveEffect:
      "Boosts the user's Attack after defeating a Dragon-type Pokemon.",
  },
  {
    id: "FLOWERFANG",
    name: "Flower Fang",
  ...
  },
  {
    ...
    target: "NearOther",
    description:
      "After attacking, the user switches out for a waiting party Pokemon.",
    suffix: "normal",
  },
  {
    id: "CRYOSPEED",
  ...
  },
  {
    ...
    target: "User",
    description:
      "The user increases it's extra effect chance a little bit. The increases duplicate if the user is grass type.",
    suffix: "normal",
  },
  {
    id: "ASTROKEOFLUCK",
    ...
    target: "NearOther",
    description:
      "The user throws a lucky punch that boosts its extra effect chance. It may also raise the user's Attack.",
    suffix: "normal",
  },
  {
    id: "GHOSTDISSOLUTION",
    name: "Ghost Dissolution",
    type: "GHOST",
    category: "Status",
    power: null,
    accuracy: null,
    ...
    target: "User",
    description:
      "The user gains Ghost debility and sharply raises evasion. Fails if the user already has a debility.",
    suffix: "normal",
    passiveEffect:
      "After using a move, if the user has Ghost debility, it has a tiny chance to pass it to the target.",
  },
  {
    id: "FROSTREQUIEM",
    name: "Frost Requiem",
    ...
    target: "NearOther",
    description:
      "The user faints to freeze the target, trap it, and apply a 5-turn perish count.",
    suffix: "normal",
  },
  {
    id: "CHAINSAWCUT",
    ...
    target: "NearOther",
    description:
      "The user tears through one target with a chainsaw-like slash. This Steel move is super effective against Grass types.",
    suffix: "normal",
  },
  {
    id: "DRACONICROAR",
    ...
    target: "AllNearOthers",
    description:
      "The user roars and applies Dragon debility to nearby foes while lowering their Special Defense.",
    suffix: "normal",
    passiveEffect:
      "At the end of each turn, if any opposing Dragon-type remains, the user gains +1 accuracy.",
  },
  {
    id: "PARALYZINGECHO",
    name: "Paralyzing Echo",
    type: "NORMAL",
    category: "Status",
    power: null,
    accuracy: 100,
    ...
    target: "NearOther",
    description:
      "The user throws a big echo that paralyzes the target and lowers its evasion.",
    suffix: "normal",
  },
  {
    id: "POISONCICLONE",
    ...
    target: "AllNearFoes",
    description:
      "The user whips up poisonous winds that hit all nearby foes and may poison them.",
    suffix: "normal",
  },
  {
    id: "LIMITBOUNDSTRIKE",
    name: "Limit Bound Strike",
    type: "FIGHTING",
    category: "Physical",
    power: 1,
    accuracy: 100,
    ...
    target: "NearOther",
    description:
      "The user strikes one target. This move's base power scales with the user's HP limit, from 60 to 120.",
    suffix: "normal",
    passiveEffect:
      "At the end of each turn, the user's HP limit is adjusted to match its current HP.",
  },
  {
    id: "FROSTTHEFT",
    name: "Frost Theft",
    ...
    target: "NearOther",
    description:
      "The user tears at the target with freezing claws and removes its held item.",
    suffix: "normal",
  },
  {
    id: "CHARGESHIELD",
    ...
    target: "User",
    description:
      "The user begins charging power and creates a tiny proto-shield.",
    suffix: "normal",
  },
  {
    id: "SKYSPLITTER",
    ...
    target: "NearOther",
    description:
      "The user summons a bolt from the heavens. This lowers the target's Speed and the user's gain a tiny protoshield in snow or rain.",
    suffix: "normal",
  },
  {
    id: "TARDRIZZLE",
    ...
    target: "NearOther",
    description:
      "The user rains poisonous tar drops on one target. It may apply Poisonous Tar.",
    suffix: "normal",
  },
  {
    id: "TARDELUGE",
    ...
    target: "AllNearFoes",
    description:
      "The user unleashes a heavy rain of poisonous tar on nearby foes. It has a high chance to apply Poisonous Tar.",
    suffix: "normal",
  },
];
