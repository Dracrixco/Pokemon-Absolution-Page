...
export const moves: Move[] = [
  ...
  },
  {
    ...
    target: "User",
    description:
      "Reduces his maximum hp a lot in exchange for improving all his stats by 1 level. The move fails if the user already has limited hp.",
    suffix: "normal",
  },
  {
    id: "EXPLOSIVEFEATHER",
    ...
    target: "NearOther",
    description:
      "The move is super effective against rock and steel types. Reduces the maximum hp of the user.",
    suffix: "normal",
  },
  {
    id: "BURNTHELIMIT",
    ...
    target: "AllNearOthers",
    description:
      "Causes damage according to the hp limit and removes the hp limiter. The move fails if the user hp is not limited.",
    suffix: "normal",
  },
  {
    id: "SOLARDESTRUCTION",
  ...
  },
  {
    ...
    target: "User",
    description:
      "Generate a tiny proto-shield for the user. The proto-shield can be accumulated.",
    suffix: "normal",
  },
  {
    id: "MARKINGTERRITORY",
    ...
    target: "AllFoes",
    description:
      "Increases both defenses, but the user can no longer be changed.",
    suffix: "normal",
    passiveEffect:
  ...
  },
  {
    ...
    target: "User",
    description:
      "The user applies 3 random resistances to themself, which can be accumulated.",
    suffix: "normal",
  },
  {
    id: "DRAGONSLAYER",
    ...
    suffix: "normal",
    passiveEffect:
      "The user increases its attack after defeating a dragon-type Pokemon.",
  },
  {
    id: "FLOWERFANG",
    name: "Flower Fang",
    ...
    target: "NearOther",
    description:
      "Bites the target with its large fangs, always reduce the target evasion.",
    suffix: "normal",
  },
  {
    id: "PREDATORYGAME",
  ...
  },
  {
    ...
    suffix: "normal",
    passiveEffect:
      "The move is likely to be executed when the user recieve damage.",
  },
  {
    id: "INTHESPOTLIGHT",
    ...
    target: "NearOther",
    description:
      "Prevents the target from escaping. The user cannot escape either.",
    suffix: "normal",
    passiveEffect: "Attacking enemies trapped in combat increases accuracy.",
  },
  {
    id: "SHERIFFSHOT",
    name: "Sheriff Shot",
    ...
    target: "NearOther",
    description:
      "The user ignores any effects that redirect moves. It has a high critical-hit ratio.",
    suffix: "normal",
  },
  {
    id: "TWILIGHTCUT",
    ...
    target: "NearOther",
    description:
      "Deals double damage if the user is in a dark area or have <b>Dark Hater</b>.",
    suffix: "normal",
  },
  {
    id: "TRIFORCE",
    ...
    target: "User",
    description:
      "Increases the attack, special attack and precision of the user.",
    suffix: "normal",
    passiveEffect: "The user get <b>Dark Hater</b> when entering combat.",
  },
  {
    id: "NIGHTFALL",
    name: "Nightfall",
    ...
    target: "BothSides",
    description:
      "Turns the combat into a dark zone, as if it were at night or in a cave. The move fails if it is already in a dark zone.",
    suffix: "normal",
  },
  {
    id: "MARTIALFANG",
    ...
    target: "NearOther",
    description:
      "Bites the target by doing a martial technique. Always reduce the target's defense.",
    suffix: "normal",
  },
  {
    id: "TELATRAPO",
    ...
    target: "NearOther",
    description:
      "Traps the enemy with a sticky cloth, preventing him from escaping for 3 turns.",
    suffix: "normal",
    passiveEffect: "Reduces the evasion of targets unable to escape.",
  },
  {
    id: "TORTUROUSGRAB",
    name: "Torturous Grab",
    ...
    target: "NearOther",
    description:
      "Causes more damage the greater the evasion difference between the user and the target.",
    suffix: "normal",
  },
  {
    id: "SILKBOMB",
  ...
  },
  {
    ...
    suffix: "normal",
    passiveEffect:
      "Upon entering battle, the user gains a silk shield that makes them immune to powder-based moves.",
  },
  {
    id: "CRYOSWITCH",
    name: "Cryo Switch",
  ...
  },
  {
    ...
    target: "NearOther",
    description:
      "This move always goes first in a hailstorm or in a Snowstorm.",
    suffix: "normal",
  },
  {
    ...
    target: "NearOther",
    description:
      "After making the attack, the user switch place with a party member. If the user is in hailstorm, this move always go first.",
    suffix: "normal",
  },
  {
    id: "WEIRDPUNCH",
